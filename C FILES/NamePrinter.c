        ...
        else if(c[k]=='o' || c[k]=='O')
        {
            for(i=0; i<7; i++)
            {
                for(j=0; j<14; j++)
                {
                    if(j%2==0)
                    {
                        if(((i==0 || i==6)&& j>0 && j<12) ||((j==0 || j==12)&& i>0 && i<6) )
                            a[k][i][j]='*';
                        else
                            a[k][i][j]=' ';
                    }
            ...
            for(i=0; i<7; i++)
            {
                for(j=0; j<14; j++)
                {
                    if(j%2==0)
                    {
                        if (j==12)
                            a[k][i][j]='0';
                        else if(i==6 || j==6 || (i==1 && j==4) || (i==2 && j<4))
                            a[k][i][j]='*';
                        else
                            a[k][i][j]=' ';
                    }
            ...
            for(i=0; i<7; i++)
            {
                for(j=0; j<14; j++)
                {
                    if(j%2==0)
                    {
                        if (j==12 || j==10)
                            a[k][i][j]='0';
                        else if(i==6 || (i==1 && j==0) || (i==0 && j>0 && j<8) || (j==8 && (i==1 || i==2)) || (j/2 + i == 6))
                            a[k][i][j]='*';
                        else
                            a[k][i][j]=' ';
                    }
            ...
            for(i=0; i<7; i++)
            {
                for(j=0; j<14; j++)
                {
                    if(j%2==0)
                    {
                        if (j==12 || j==10)
                            a[k][i][j]='0';
                        else if(((i==0 ||i==3 || i==6) && j>0 && j<8)||((i>0 && i<6 && i!=3)&&j==8)  ||((i==1 || i==5) && j==0))
                            a[k][i][j]='*';
                        else
                            a[k][i][j]=' ';
                    }
            ...
            for(i=0; i<7; i++)
            {
                for(j=0; j<14; j++)
                {
                    if(j%2==0)
                    {
                        if (j==12 || j==10)
                            a[k][i][j]='0';
                        else if(((i==0)&&j>=0 && j<=8) || ((i==2)&&(j>=0 &&j<8))|| ((i==6)&&(j>0 &&j<8)) ||(j==0 && i>0 && i<=3) || (j==8 && i>2 && i<6))
                            a[k][i][j]='*';
                        else
                            a[k][i][j]=' ';
                    }
            ...
            for(i=0; i<7; i++)
            {
                for(j=0; j<14; j++)
                {
                    if(j%2==0)
                    {
                        if (j==12 || j==10)
                            a[k][i][j]='0';
                        else if(((i==0||i==6)&&j>0 && j<8) ||(i==3 && j<8)||((i>0 && i<6 && i!=3)&&j==0) || ((i==1 || i==4 || i==5)&&j==8))
                            a[k][i][j]='*';
                        else
                            a[k][i][j]=' ';
                    }
            ...
            for(i=0; i<7; i++)
            {
                for(j=0; j<14; j++)
                {
                    if(j%2==0)
                    {
                        if (j==12 || j==10)
                            a[k][i][j]='0';
                        else if(((i==0||i==3||i==6)&&j>0 && j<8)||((i>0 && i<6 && i!=3)&&(j==8||j==0)))
                            a[k][i][j]='*';
                        else
                            a[k][i][j]=' ';
                    }
            ...
            for(i=0; i<7; i++)
            {
                for(j=0; j<14; j++)
                {
                    if(j%2==0)
                    {
                        if (j==12 || j==10)
                            a[k][i][j]='0';
                        else if(((i==0||i==3||i==6)&&j>0 && j<8)||((i>0 && i<3)&&j==0) || (i>0 && i<6 && j==8) || (i==5 && j==0))
                            a[k][i][j]='*';
                        else
                            a[k][i][j]=' ';
                    }
